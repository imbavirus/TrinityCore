...
namespace Connection_Patcher
{
    namespace Patterns
    {
        struct Common
        {
			...
			static const std::vector<unsigned char> Config()  { return{ 'C', 'o', 'n', 'f', 'i', 'g', '.', 'w', 't', 'f', 0x00 }; }
			//static const std::vector<unsigned char> Tag()  { return{ 0x80, 0x9E, 0xE0, 0x00 }; }
			static const std::vector<unsigned char> Tag() { return{ 'N', 'o', 'v', ' ', '1', '1', ' ', '2', '0', '1', '5', 0x00 }; }
			...
			static const std::vector<unsigned char> OpenSpace() { return{ 0x00, 0x40, 0x00, 0x00, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
